document.addEventListener("DOMContentLoaded", () => {
    ...
    const applyMobileVideoSources = () => {
        ...
        document.querySelectorAll("video").forEach((video) => {
            ...
            const mobileSrc = mobileSource?.getAttribute("src");

            if (!mobileSrc || video.dataset.mobileSrcApplied === mobileSrc) {
                return;
            }

            video.dataset.mobileSrcApplied = mobileSrc;
            video.src = mobileSrc;
